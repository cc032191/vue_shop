<template>
  <el-dialog title="分配角色" :visible.sync="dialogVisible" width="30%" @close="reset">
    <!-- 主体 -->
    <el-form :model="roleForm" ref="roleForm" label-width="70px">
      ...
      <el-form-item label="新角色" prop="role_names">
        <el-select v-model="roleForm.newrole_name" placeholder="请选择新角色">
          <el-option v-for="item in roleobj" :key="item.id" :label="item.roleName" :value="item.id"></el-option>
        </el-select>
      </el-form-item>
    </el-form>
